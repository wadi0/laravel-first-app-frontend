...
const Navbar = () => {
    ...
    const menuItems = [
    { name: 'Home', path: '/' },
    { name: 'Shop', path: '/shop', dropdown: ['All Products', 'Featured', 'Best Sellers'] },
    { name: 'About Us', path: '/about' },
    { name: 'Blog', path: '/blog', dropdown: ['Latest Posts', 'Tutorials'] },
    { name: 'Categories', path: '/categories', dropdown: ['Men', 'Women', 'Kids'] },
    { name: 'Pages', path: '/pages', dropdown: ['FAQ', 'Terms', 'Privacy'] },
    ...
    return (
        <>
            <header className="navbar-main">
                <div
                    className={`navbar-container ${searchActive ? 'search-active' : ''} ${mobileSidebarOpen ? 'blurred' : ''}`}>
